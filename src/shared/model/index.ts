...
export { ILogger, IConfiguration, IParser, IWriter, IReader, IInject, IDialogues, IEditor, IFileSystem, DocumentOpener, JournalController, IWorkspaceConfigReader, EntryOpenedEvent, IJournalEvents } from './interfaces';
